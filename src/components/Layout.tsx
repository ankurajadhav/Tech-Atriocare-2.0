      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-4 group shrink-0">
             <div className={cn(
              "w-11 h-11 rounded-xl flex items-center justify-center bg-white shadow-[0_4px_20px_rgba(14,165,233,0.1)] border border-sky-100 transition-all duration-500 overflow-hidden",
            ...
            <div className="flex flex-col">
              <span className="text-xl font-extrabold font-display tracking-tight uppercase leading-none text-slate-950 group-hover:text-brand-teal transition-all duration-500">
                Tech AtrioCare
              </span>
              <span className="text-[8.5px] font-black tracking-[0.2em] uppercase mt-1 text-slate-500 group-hover:text-brand-teal transition-all duration-500 leading-none">
          ...
          <div className="hidden md:flex items-center gap-10">
              ...
              {navLinks.map((link) => {
                ...
                return link.href.startsWith('/#') ? (
                  <a
                    ...
                    href={link.href}
                    className={cn(
                      "text-[11px] font-black uppercase tracking-widest transition-all py-2 px-3.5 rounded-full relative",
                      isActive 
            ...
            <Link 
              to="/checkup"
              className="relative atrio-gradient text-white px-8 py-4 rounded-full text-xs font-black shadow-[0_15px_30px_-5px_rgba(0,184,166,0.3)] hover:-translate-y-1.5 transition-all flex items-center gap-4 group overflow-hidden active:scale-95"
            >
              <motion.div 
                animate={{
                  opacity: [0.3, 0.8, 0.3],
          ...
          <button 
            className="md:hidden p-2 text-slate-800 hover:text-brand-teal"
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div 
              ...
              exit={{ opacity: 0, y: -20 }}
              className="md:hidden absolute top-full left-0 right-0 bg-white/95 border-b border-slate-200/80 p-6 shadow-2xl flex flex-col gap-4 backdrop-blur-2xl"
            >
              {navLinks.map((link) => (
        ...
        <div className="bg-white py-6 mb-16 shadow-sm">
          <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <Link to="/" className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white border border-slate-200 shadow-sm rounded-lg flex items-center justify-center overflow-hidden">
                <img 
                  src="https://lh3.googleusercontent.com/d/1wXu_Vb5F6ihb6wEcXWhDYkfNjz28mPDA" 
                  alt="Tech AtrioCare Logo" 
