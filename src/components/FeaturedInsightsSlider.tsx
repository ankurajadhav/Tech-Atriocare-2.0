  ...
  const slides = [
    {
      id: 1,
      type: 'product',
      image: "https://lh3.googleusercontent.com/d/1Eo68kJvgJzO5RasRQ5_L9SMyEPwrxEf9",
      title: "Live Now ! Haal-Chaal Pravartak 1.0",
      ...
      link: "/haal-chaal?action=register",
      isExternal: false,
      tag: "Live Challenge",
    ...
    },
    {
      ...
      description: "Delhi-Based Startup Tech AtrioCare Revolutionizes Healthcare with AI-Powered Voice-Based Digital Gym and NOVICULE-TA formulation.",
    ...
    },
    {
      id: 3,
      type: 'product',
      image: "https://lh3.googleusercontent.com/d/1hDSPUhi5jzwhw1_23GtqYx-bngafO8y5",
      title: "Novicule-TA",
            ...
            >
                ...
                {currentSlide.type === 'press-mock' ? (
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-start flex-1">
                        ...
                        <div className="sm:col-span-5 relative rounded-2xl overflow-hidden border border-slate-100 shadow-sm aspect-video sm:aspect-square">
                          <img 
                            ...
                            alt="AI-Powered Voice Gym App Interface" 
                        ...
                        <div className="sm:col-span-7 space-y-2 text-left">
                          ...
                          <h4 className="text-sm md:text-base font-black text-slate-900 leading-snug tracking-tight">
                            Delhi-Based Startup Tech AtrioCare Revolutionizes Healthcare with AI-Powered Voice-Based Digital Gym and NOVICULE-TA formulation
                          </h4>
                  ...
                  <div className="w-full h-full relative group">
                    <img 
                      ...
                      className={`w-full h-full ${currentIndex === 2 ? 'object-contain p-6 bg-slate-50/40' : 'object-cover'} transition-transform duration-700`}
                      referrerPolicy="no-referrer"
                    />
              ...
              <div className="flex-1 p-8 md:p-12 flex flex-col justify-between text-left">
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="text-2xl md:text-3xl font-extrabold text-brand-blue tracking-tight leading-tight">
                    {currentSlide.title}
                  </h3>
