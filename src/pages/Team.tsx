...
const specialMentions = [
  ...
  },
  {
    name: "Ankur Jadhav",
    years: "",
    role: "Website Creator, Redesigner, UI UX and more",
    bio: "Architecting the digital presence of AtrioCare with professional precision and modern design standards.",
    image: "https://lh3.googleusercontent.com/d/1q6OrPJj9tPx1-2Bi6jG0yQ1rtpnnReJC",
    type: "Digital Architect"
  }
];
...
const internBatches = [
  ...
  { batch: "Batch-5 Interns", names: ["Ankur Jadhav"] }
];
              ...
              >
                <div className="grid md:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="text-left space-y-6">
                    <div>
                      <h3 className="text-4xl font-black text-black tracking-tighter uppercase font-display leading-none">{mention.name}</h3>
