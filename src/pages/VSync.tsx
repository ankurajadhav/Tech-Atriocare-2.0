...
export default function VSyncPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#ca7df0] to-[#eb7cd5] text-white font-sans selection:bg-white/20 selection:text-white overflow-x-hidden pt-28">
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-12 gap-12 items-center relative z-10">
            ...
            >
              <div className="flex flex-col space-y-4">
                ...
                <p 
                  ...
                  className="text-4xl md:text-5xl text-[#fecdd3] font-bold italic tracking-wide pl-12 md:pl-24 -mt-4 select-text drop-shadow-sm"
                >
                  vaani, verve & vibes
                </p>
              </div>
              ...
              <div className="pt-8 pl-12 md:pl-24">
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-14 py-5 bg-[#8b31f0] hover:bg-[#7c26df] text-white font-semibold text-xl rounded-[24px] shadow-[0_12px_24px_rgba(139,49,240,0.35)] transition-all tracking-wider"
                >
                  Quick Start
                </motion.button>
              </div>
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end select-none">
            <motion.div
              ...
              className="relative bg-white p-5 pb-7 rounded-[32px] shadow-2xl shadow-[#310052]/30 border border-white/60 max-w-[520px] w-full transform -rotate-2 hover:rotate-0 hover:scale-[1.02] transition-all duration-500 ease-out cursor-default"
            >
              {/* Outer light sheen highlight */}
              ...
              <div className="mt-5 pt-4 border-t border-slate-100 flex items-center justify-between text-slate-500">
                ...
                <div className="flex items-center space-x-1.5 bg-rose-50 px-3 py-1.5 rounded-full">
                  <div className="w-2 h-2 rounded-full bg-rose-500 animate-pulse" />
                  <span style={{ fontFamily: '"Dancing Script", cursive' }} className="text-rose-600 text-sm font-bold">
                    Vibe Check ✨
                  </span>
                </div>
              </div>
          ...
          >
            ...
            <div className="bg-white/10 rounded-[40px] p-6 shadow-2xl border border-white/15 transition-all hover:border-white/35 hover:shadow-pink-900/50 max-w-lg w-full">
              <img 
                ...
                className="w-full h-auto rounded-[24px] shadow-sm object-contain bg-white/5"
              />
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-32 px-6 md:px-20 bg-transparent text-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
          ...
          >
            {/* Screenshot 3 smartphone image mock */}
            <div className="rounded-[48px] overflow-hidden shadow-2xl bg-white/10 p-6 border-8 border-white/20 max-w-md w-full">
              <img 
                src={wellnessCompanion} 
                alt="Smartphone Interface" 
                className="w-full h-auto rounded-[36px] object-contain bg-white/5"
              />
            </div>
          </motion.div>
      ...
      {/* Testimonials */}
      <section className="py-32 px-6 md:px-20 bg-pink-950/20 border-y border-white/10 text-white">
      ...
      <section className="py-40 px-6 md:px-20 bg-transparent space-y-40 text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            <motion.div 
              whileHover={{ scale: 1.05 }}
              className="rounded-[60px] overflow-hidden shadow-xl bg-white border border-pink-200 p-2 flex flex-col items-center justify-center aspect-square relative group isolate"
            >
               <img 
                 src={vaaniResonance} 
                 alt="Vaani Vocal Resonance" 
                 className="absolute inset-0 w-full h-full object-cover rounded-[50px] -z-10 opacity-90 transition-opacity"
               />
               <h3 className="w-full text-center text-6xl font-serif text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)] z-10">Vaani</h3>
            </motion.div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <motion.div 
              whileHover={{ scale: 1.05 }}
              className="order-2 lg:order-1 rounded-[60px] overflow-hidden shadow-xl bg-white border border-pink-200 p-2 flex flex-col items-center justify-center aspect-square relative group isolate"
            >
               <img 
                 src={verveConnection} 
                 ...
                 className="absolute inset-0 w-full h-full object-cover rounded-[50px] -z-10 opacity-90 transition-opacity"
               />
               <h3 className="w-full text-center text-6xl font-serif text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)] z-10">Verve</h3>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            >
               <img 
                 ...
                 className="absolute inset-0 w-full h-full object-cover rounded-[50px] -z-10 opacity-90 transition-opacity"
               />
               <h3 className="w-full text-center text-6xl font-serif text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)] z-10">Vibes</h3>
            </motion.div>
          </div>
        </div>
      </section>
